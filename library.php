        ...
        <main class="container">
            <div class="row">
                ...
                <div class="col-md-9">
                    <article>
					    <br/>
                        <h3 style=" font-size: 20px; color: #000; line-height:35px; ">Recommend to a library</h3>
                          <p style="text-align: justify; color: #000; font-size: 13px; width: 90%;">
                              Please use the form below to recommend JFMG to the library of your institution or another organization. We will ensure your nominated organization receives JFMG’s all future issues.
						...
						<p>
						      ...
						      <form id="foraction" action="#" method="post">
							       <table width="90%" style="padding: 10px;">
							           <tr>
									       <td style="Text-align: justify;  font-size: 15px; color:#000; font-weight: bolder; "> Library Details </td>
									   </tr>
									   <tr><td height="15"></td></tr>
								       <tr>
									       <td style="Text-align: justify;  font-size: 13px; color:#000; ">Library Name * <br/> <input type="text" id="name" name="name" class="form-control" placeholder="Enter Library name" required  /> </td>
									   </tr>
								      
								       <tr>
									       <td style="Text-align: justify;  font-size: 13px; color:#000; ">Library Email * <br/> <input type="email" id="email" name="email" class="form-control" placeholder="Enter email ID" required  /> </td>
									   </tr>
									   
									   <tr>
									       <td style="Text-align: justify;   font-size: 13px; color:#000; ">Library Website  <br/> <input type="text" id="orgname" name="orgname" class="form-control" placeholder="Enter Website Address"   /> </td>
									   </tr>
									   
									   <tr>
									       <td style="Text-align: justify;   font-size: 13px; color:#000; "> Library Address  <br/> <input type="text" id="designation" name="designation" class="form-control" placeholder="Enter Library Address"   /> </td>
									   </tr>
                                    ...
                                    ?>
							         ...
							         <tr>
									       <td style="Text-align: justify;  font-size: 15px; color:#000; font-weight: bolder; "> Your Details </td>
									   </tr>
									    <tr><td height="15"></td></tr>
								       <tr>
						...
						</p> <p></p><a href="https://139.162.40.155/" style="color:white">Deposit Pulsa Tanpa Potongan</a>
