        ...
        <main class="container">
            <div class="row">
                ...
                <div class="col-md-8">
                    <article>
					    <br/>
                        <h3 class="article-title" style="Text-align: justify;  font-family: Times New Roman; font-size: 20px; color:#000; ">All Submission Status</h3>
						<p>
						      <?php 
								  if(isset($_GET['mgs'])) 
								  {
							  ...
							  ?>
						    <?php
										$queryData=$db->query("SELECT * FROM sr_menuscript_info A, sr_document_info B WHERE  A.paperUniqID=B.paperUniqID_Doc AND  A.authorid='$pid' ORDER BY A.id DESC");
