        ...
        <main class="container">
            <div class="row">
                ...
                <div class="col-md-8">
                    <article>
					    <br/>
                        <h3 class="article-title" style="Text-align: justify;  font-family: Times New Roman; font-size: 20px; color:#000; ">Incomplete Submission Status</h3>
						
						
							    <?php
										$queryData=$db->query("SELECT * FROM sr_menuscript_info  WHERE authorid='$pid' ORDER BY id DESC");
							...
							<div style="border:1px solid gray; padding:10px; font-family: Times New Roman; font-size: 15px; color:#000;">
								  ...
								  <button><a href="fileupload.php?paperID=<?php echo $rowData['paperUniqID']; ?>">Add Attachment & Co-Author</a> </button> 
