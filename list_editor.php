        ...
        <main class="container">
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <article>
					    <br/>
					    <p align="right"><a href='editor_reviwer_reg.php?getID=1'><button style="width: 150px; height: 40px; background-color: #4C7CBA; color:#fff; font-weight:bolder;">Add New</button></a></p>
                        <h3 class="article-title" style="Text-align: justify;  font-size: 20px; color:#000; ">Editorial Board</h3>
...
<td width="200" align="center">
    <a href="editor_reviwer_reg.php?getID=1&editID=<?php echo $rowAuthor['id'];  ?>"><button class="btn btn-primary" style="width:80px; height:;">Edit</button> </a>
    <a href="editor_reviwer_reg.php?getID=1&DELETEID=<?php echo $rowAuthor['id'];  ?>"><button class="btn btn-danger" style="width:80px; height:;">Remove</button> </a>
</td>
</tr>
