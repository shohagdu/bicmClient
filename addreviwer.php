...
<script type="text/javascript">
   function fnc_more_author_info(){
    if(fn_validation('name*deg*email*orgname*country')==0) return;
    var name=$('#name').val();
    var email=$('#email').val();
    ...
    var data ="action=save_Reviwer_info&name="+name+"&email="+email+"&orgname="+orgname+"&country="+country+"&deg="+deg+'&mobile='+mobile;
    //alert(data); return;
  ...
  function fnc_more_author_info_response()
  {
    ...
    { 
      ...
      if(response==1){
		  alert('Added new Reviwer');
		  window.location="addreviwer.php?sk=1";
	  }
     }
  }  
        ...
        <main class="container">
            <div class="row">
                ...
                <div class="col-md-8">
                    <article>
					    <br/>
                        <h3 class="article-title" style="Text-align: justify;  font-family: Times New Roman; font-size: 20px; color:#000; ">Add New Reviwer</h3>
						<p>
						      <?php 
								  if(isset($_GET['mgs'])) 
								  {
									   if($_GET['mgs']==1)
									   {
										   echo '<div class="alert alert-primary" role="alert" style="width:90%; color: green;"> Reviwer Added!</div>';
									   }
									   else{
						      ...
						      <form id="foraction" action="include/loginsecure.php" method="post"  enctype="multipart/form-data">
							       ...
							       <table width="100%">
												   ...
												   <tr>
												    ...
												    <tr>
													   <td> Mobile <br/> <input type="number" id="mobile" name="mobile" class="form-control" placeholder="Enter your mobile no."   /> </td>
												   </tr>
												   	   <tr>
