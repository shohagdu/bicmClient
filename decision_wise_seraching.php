   ...
   $pid=$_SESSION['loguniqID'];
    ...
    $QueryEditRemove=$db->query("DELETE FROM sr_menuscript_info WHERE paperUniqID='$DELETEID'");
        if($QueryEditRemove==1)
        {
            ...
            header("location:decision_wise_seraching.php?mgsalt=10");
...
<script>
 ...
 function fnc_data_search()
 {
    ...
    var data ="action=decision_wise_data_search&DecisionID="+DecisionID;
    //alert(data); return;
                ...
                <div class="col-md-8">
                    <article>
                            <?php 
							  ...
							  ?>
					    <br/>
                        <h3 class="article-title" style="Text-align: justify;  font-family: Times New Roman; font-size: 20px; color:#000; ">Decision wise papers search</h3>
                       
						  <table width="100%">
<tr>
	
	   <td style="color: black;">Decision category</td>
